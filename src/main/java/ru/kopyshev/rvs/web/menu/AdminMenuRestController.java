...
public class AdminMenuRestController extends AbstractMenuController {
    ...
    public ResponseEntity<MenuDTO> createWithLocation(@RequestBody MenuUpdateDTO menuUpdateDTO) {
    ...
    public void update(@RequestBody MenuUpdateDTO menuUpdateDTO, @PathVariable Integer id) {
